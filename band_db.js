...
function set_up_band_db(){
	//alert("DB");
		...
		tx.executeSql('INSERT INTO bands (id, band_name, stage, day, start_time, finish_time, band_fav, stage_rank, day_name, video_link) VALUES (3, "Incinery", "Sophie Lancaster Stage", 20150219, 2005, 2035, 0, 1, "Thursday", "video_link_HERE")');
		tx.executeSql('INSERT INTO bands (id, band_name, stage, day, start_time, finish_time, band_fav, stage_rank, day_name, video_link) VALUES (4, "Monument", "Sophie Lancaster Stage", 20150219, 2055, 2135, 0, 1, "Thursday", "video_link_HERE")');
		tx.executeSql('INSERT INTO bands (id, band_name, stage, day, start_time, finish_time, band_fav, stage_rank, day_name, video_link) VALUES (5, "Jaldaboath", "Sophie Lancaster Stage", 20150219, 2205, 2245, 0, 1, "Thursday", "video_link_HERE")');
